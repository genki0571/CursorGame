...
public class NearBombEnemy : EnemyBase, IDamagable, ISelectable, IGrabbable, IHaveWeakPoint
{
    ...
    const float BOMB_INTERVAL = 3;

    const float BOMB_RADIUS_S = 0.5f;
    const float BOMB_STAN_INTERVAL_S = 1;
